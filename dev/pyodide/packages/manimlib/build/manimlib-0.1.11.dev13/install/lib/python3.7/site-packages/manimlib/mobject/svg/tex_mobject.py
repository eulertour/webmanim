...
from manimlib.utils.tex_string_parsing import get_modified_expression
...
class SingleStringTexMobject(SVGMobject):
    ...
    def __init__(self, tex_string, **kwargs):
        ...
        svg_data = js.tex_to_svg_data(get_modified_expression(tex_string, alignment=self.alignment))
        if svg_data is None:
        ...
        ## )
        SVGMobject.__init__(self, svg_data=svg_data, **kwargs)
