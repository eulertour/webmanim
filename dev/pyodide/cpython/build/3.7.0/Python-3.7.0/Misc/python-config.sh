...
prefix="/src/cpython/installs/python-3.7.0"
exec_prefix="${prefix}"
...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS="-lpython${VERSION}${ABIFLAGS} -lintl -ldl  $SYSLIBS"
...
LIBPL=$(echo "$(prefix)/lib/python3.7/config-$(VERSION)$(ABIFLAGS)" | sed "s#$prefix#$prefix_real#")
SO=".so"
PYTHONFRAMEWORK=""
